...
Jaeger is a distributed tracing platform for monitoring microservices-based distributed systems.
...
The command deploys jaeger on the Kubernetes cluster in the default configuration. The [Parameters](#parameters) section lists the parameters that can be configured during installation.
...
### Jaeger image parameters

| Name                | Description                                                                                             | Value                 |
| ------------------- | ------------------------------------------------------------------------------------------------------- | --------------------- |
| `image.registry`    | Jaeger image registry                                                                                  | `docker.io`           |
| `image.repository`  | Jaeger image repository                                                                                | `bitnami/jaeger`     |
| `image.tag`         | Jaeger image tag (immutable tags are recommended)                                                      | `2.4.14-debian-11-r0` |
| `image.digest`      | Jaeger image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag | `""`                  |
| `image.pullPolicy`  | Jaeger image pull policy                                                                               | `IfNotPresent`        |
| `image.pullSecrets` | Jaeger image pull secrets                                                                              | `[]`                  |
| `image.debug`       | Enable Jaeger image debug mode                                                                         | `false`               |


### Jaeger application controller parameters

| Name                                                           | Description                                                                                          | Value           |
| -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | --------------- |
| `controller.replicaCount`                                      | Number of Jaeger replicas to deploy                                                                 | `1`             |
| `controller.startupProbe.enabled`                              | Enable startupProbe on Jaeger nodes                                                                 | `false`         |
...
| `controller.livenessProbe.enabled`                             | Enable livenessProbe on Jaeger nodes                                                                | `true`          |
...
| `controller.readinessProbe.enabled`                            | Enable readinessProbe on Jaeger nodes                                                               | `true`          |
...
| `controller.resources.limits`                                  | The resources limits for the Jaeger containers                                                      | `{}`            |
| `controller.resources.requests`                                | The requested resources for the Jaeger containers                                                   | `{}`            |
| `controller.podSecurityContext.enabled`                        | Enabled Jaeger pods' Security Context                                                               | `true`          |
| `controller.podSecurityContext.fsGroup`                        | Set Jaeger pod's Security Context fsGroup                                                           | `1001`          |
| `controller.containerSecurityContext.enabled`                  | Enabled Jaeger containers' Security Context                                                         | `true`          |
| `controller.containerSecurityContext.runAsUser`                | Set Jaeger containers' Security Context runAsUser                                                   | `1001`          |
| `controller.containerSecurityContext.allowPrivilegeEscalation` | Set Jaeger containers' Security Context allowPrivilegeEscalation                                    | `false`         |
| `controller.containerSecurityContext.capabilities.drop`        | Set Jaeger containers' Security Context capabilities to be dropped                                  | `["all"]`       |
| `controller.containerSecurityContext.readOnlyRootFilesystem`   | Set Jaeger containers' Security Context readOnlyRootFilesystem                                      | `false`         |
| `controller.containerSecurityContext.runAsNonRoot`             | Set Jaeger container's Security Context runAsNonRoot                                                | `true`          |
...
| `controller.logFormat`                                         | Format for the Jaeger application controller logs. Options: [text, json]                            | `text`          |
| `controller.logLevel`                                          | Log level for the Jaeger application controller                                                     | `info`          |
| `controller.containerPorts.controller`                         | Jaeger application controller port number                                                           | `8082`          |
| `controller.containerPorts.metrics`                            | Jaeger application controller metrics port number                                                   | `8082`          |
| `controller.service.type`                                      | Jaeger service type                                                                                 | `ClusterIP`     |
| `controller.service.port`                                      | Jaeger application controller service port                                                          | `8082`          |
| `controller.service.nodePort`                                  | Node port for Jaeger application controller service                                                 | `""`            |
| `controller.service.clusterIP`                                 | Jaeger application controller service Cluster IP                                                    | `""`            |
| `controller.service.loadBalancerIP`                            | Jaeger application controller service Load Balancer IP                                              | `""`            |
| `controller.service.loadBalancerSourceRanges`                  | Jaeger application controller service Load Balancer sources                                         | `[]`            |
| `controller.service.externalTrafficPolicy`                     | Jaeger application controller service external traffic policy                                       | `Cluster`       |
| `controller.service.annotations`                               | Additional custom annotations for Jaeger application controller service                             | `{}`            |
...
| `controller.metrics.enabled`                                   | Enable Jaeger application controller metrics                                                        | `false`         |
| `controller.metrics.service.type`                              | Jaeger application controller service type                                                          | `ClusterIP`     |
| `controller.metrics.service.port`                              | Jaeger application controller metrics service port                                                  | `8082`          |
| `controller.metrics.service.nodePort`                          | Node port for the application controller service                                                     | `""`            |
| `controller.metrics.service.clusterIP`                         | Jaeger application controller metrics service Cluster IP                                            | `""`            |
| `controller.metrics.service.loadBalancerIP`                    | Jaeger application controller service Load Balancer IP                                              | `""`            |
| `controller.metrics.service.loadBalancerSourceRanges`          | Jaeger application controller service Load Balancer sources                                         | `[]`            |
| `controller.metrics.service.externalTrafficPolicy`             | Jaeger application controller service external traffic policy                                       | `Cluster`       |
| `controller.metrics.service.annotations`                       | Additional custom annotations for Jaeger application controller service                             | `{}`            |
...
| `controller.defaultArgs.statusProcessors`                      | Default status processors for Jaeger controller                                                     | `20`            |
| `controller.defaultArgs.operationProcessors`                   | Default operation processors for Jaeger controller                                                  | `10`            |
| `controller.defaultArgs.appResyncPeriod`                       | Default application resync period for Jaeger controller                                             | `180`           |
| `controller.defaultArgs.selfHealTimeout`                       | Default self heal timeout for Jaeger controller                                                     | `5`             |
| `controller.args`                                              | Override default container args (useful when using custom images). Overrides the defaultArgs.        | `[]`            |
| `controller.extraArgs`                                         | Add extra arguments to the default arguments for the Jaeger controller                              | `[]`            |
| `controller.hostAliases`                                       | Jaeger pods host aliases                                                                            | `[]`            |
| `controller.podLabels`                                         | Extra labels for Jaeger pods                                                                        | `{}`            |
| `controller.podAnnotations`                                    | Annotations for Jaeger pods                                                                         | `{}`            |
| `controller.podAffinityPreset`                                 | Pod affinity preset. Ignored if `controller.affinity` is set. Allowed values: `soft` or `hard`       | `""`            |
| `controller.podAntiAffinityPreset`                             | Pod anti-affinity preset. Ignored if `controller.affinity` is set. Allowed values: `soft` or `hard`  | `soft`          |
| `controller.nodeAffinityPreset.type`                           | Node affinity preset type. Ignored if `controller.affinity` is set. Allowed values: `soft` or `hard` | `""`            |
| `controller.nodeAffinityPreset.key`                            | Node label key to match. Ignored if `controller.affinity` is set                                     | `""`            |
| `controller.nodeAffinityPreset.values`                         | Node label values to match. Ignored if `controller.affinity` is set                                  | `[]`            |
| `controller.affinity`                                          | Affinity for Jaeger pods assignment                                                                 | `{}`            |
| `controller.nodeSelector`                                      | Node labels for Jaeger pods assignment                                                              | `{}`            |
| `controller.tolerations`                                       | Tolerations for Jaeger pods assignment                                                              | `[]`            |
...
| `controller.updateStrategy.type`                               | Jaeger statefulset strategy type                                                                    | `RollingUpdate` |
| `controller.priorityClassName`                                 | Jaeger pods' priorityClassName                                                                      | `""`            |
| `controller.runtimeClassName`                                  | Name of the runtime class to be used by pod(s)                                                       | `""`            |
| `controller.lifecycleHooks`                                    | for the Jaeger container(s) to automate configuration before or after startup                       | `{}`            |
| `controller.extraEnvVars`                                      | Array with extra environment variables to add to Jaeger nodes                                       | `[]`            |
| `controller.extraEnvVarsCM`                                    | Name of existing ConfigMap containing extra env vars for Jaeger nodes                               | `""`            |
| `controller.extraEnvVarsSecret`                                | Name of existing Secret containing extra env vars for Jaeger nodes                                  | `""`            |
| `controller.extraVolumes`                                      | Optionally specify extra list of additional volumes for the Jaeger pod(s)                           | `[]`            |
| `controller.extraVolumeMounts`                                 | Optionally specify extra list of additional volumeMounts for the Jaeger container(s)                | `[]`            |
| `controller.sidecars`                                          | Add additional sidecar containers to the Jaeger pod(s)                                              | `[]`            |
| `controller.initContainers`                                    | Add additional init containers to the Jaeger pod(s)                                                 | `[]`            |


### Jaeger server Parameters

| Name                                                       | Description                                                                                                                     | Value                    |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| `server.replicaCount`                                      | Number of Jaeger server replicas to deploy                                                                                     | `1`                      |
| `server.startupProbe.enabled`                              | Enable startupProbe on Jaeger server nodes                                                                                     | `false`                  |
...
| `server.livenessProbe.enabled`                             | Enable livenessProbe on Jaeger server nodes                                                                                    | `true`                   |
...
| `server.readinessProbe.enabled`                            | Enable readinessProbe on Jaeger server nodes                                                                                   | `true`                   |
...
| `server.resources.limits`                                  | The resources limits for the Jaeger server containers                                                                          | `{}`                     |
| `server.resources.requests`                                | The requested resources for the Jaeger server containers                                                                       | `{}`                     |
| `server.podSecurityContext.enabled`                        | Enabled Jaeger server pods' Security Context                                                                                   | `true`                   |
| `server.podSecurityContext.fsGroup`                        | Set Jaeger server pod's Security Context fsGroup                                                                               | `1001`                   |
| `server.containerSecurityContext.enabled`                  | Enabled Jaeger server containers' Security Context                                                                             | `true`                   |
| `server.containerSecurityContext.runAsUser`                | Set Jaeger server containers' Security Context runAsUser                                                                       | `1001`                   |
| `server.containerSecurityContext.allowPrivilegeEscalation` | Set Jaeger server containers' Security Context allowPrivilegeEscalation                                                        | `false`                  |
| `server.containerSecurityContext.capabilities.drop`        | Set Jaeger containers' server Security Context capabilities to be dropped                                                      | `["all"]`                |
| `server.containerSecurityContext.readOnlyRootFilesystem`   | Set Jaeger containers' server Security Context readOnlyRootFilesystem                                                          | `false`                  |
| `server.containerSecurityContext.runAsNonRoot`             | Set Jaeger server containers' Security Context runAsNonRoot                                                                    | `true`                   |
| `server.autoscaling.enabled`                               | Enable Jaeger server deployment autoscaling                                                                                    | `false`                  |
| `server.autoscaling.minReplicas`                           | Jaeger server deployment autoscaling minimum number of replicas                                                                | `1`                      |
| `server.autoscaling.maxReplicas`                           | Jaeger server deployment autoscaling maximum number of replicas                                                                | `5`                      |
| `server.autoscaling.targetCPU`                             | Jaeger server deployment autoscaling target CPU percentage                                                                     | `50`                     |
| `server.autoscaling.targetMemory`                          | Jaeger server deployment autoscaling target CPU memory                                                                         | `50`                     |
| `server.insecure`                                          | Disable HTTPS redirection for Jaeger server                                                                                    | `false`                  |
| `server.logFormat`                                         | jaeger server logs format. Options: [text, json]                                                                                | `text`                   |
| `server.logLevel`                                          | jaeger server logs level                                                                                                        | `info`                   |
| `server.configEnabled`                                     | Enable Jaeger server config                                                                                                    | `true`                   |
| `server.url`                                               | Jaeger server base URL. Required when configuring SSO. Required when enabling dex.                                             | `""`                     |
| `server.config`                                            | Jaeger server configuration that will end on the jaeger-cm Config Map                                                          | `{}`                     |
| `server.ingress.enabled`                                   | Enable the creation of an ingress for the Jaeger server                                                                        | `false`                  |
| `server.ingress.pathType`                                  | Path type for the Jaeger server ingress                                                                                        | `ImplementationSpecific` |
| `server.ingress.apiVersion`                                | Ingress API version for the Jaeger server ingress                                                                              | `""`                     |
| `server.ingress.hostname`                                  | Ingress hostname for the Jaeger server ingress                                                                                 | `jaeger.server.local`    |
| `server.ingress.annotations`                               | Annotations for the Jaeger server ingress. To enable certificate autogeneration, place here your cert-manager annotations.     | `{}`                     |
| `server.ingress.tls`                                       | Enable TLS for the Jaeger server ingress                                                                                       | `false`                  |
| `server.ingress.extraHosts`                                | Extra hosts array for the Jaeger server ingress                                                                                | `[]`                     |
| `server.ingress.path`                                      | Path array for the Jaeger server ingress                                                                                       | `/`                      |
| `server.ingress.extraPaths`                                | Extra paths for the Jaeger server ingress                                                                                      | `[]`                     |
| `server.ingress.extraTls`                                  | Extra TLS configuration for the Jaeger server ingress                                                                          | `[]`                     |
...
| `server.metrics.enabled`                                   | Enable metrics for the Jaeger server                                                                                           | `false`                  |
| `server.metrics.service.type`                              | Jaeger server service type                                                                                                     | `ClusterIP`              |
| `server.metrics.service.port`                              | Jaeger server metrics service port                                                                                             | `8083`                   |
| `server.metrics.service.nodePort`                          | Node port for Jaeger server metrics service                                                                                    | `""`                     |
| `server.metrics.service.clusterIP`                         | Jaeger server metrics service Cluster IP                                                                                       | `""`                     |
| `server.metrics.service.loadBalancerIP`                    | Jaeger server service Load Balancer IP                                                                                         | `""`                     |
| `server.metrics.service.loadBalancerSourceRanges`          | Jaeger server service Load Balancer sources                                                                                    | `[]`                     |
| `server.metrics.service.externalTrafficPolicy`             | Jaeger server service external traffic policy                                                                                  | `Cluster`                |
| `server.metrics.service.annotations`                       | Additional custom annotations for Jaeger server service                                                                        | `{}`                     |
...
| `server.ingressGrpc.enabled`                               | Enable the creation of an ingress for the Jaeger gRPC server                                                                   | `false`                  |
| `server.ingressGrpc.pathType`                              | Path type for the Jaeger gRPC server ingress                                                                                   | `ImplementationSpecific` |
| `server.ingressGrpc.apiVersion`                            | Ingress API version for the Jaeger gRPC server ingress                                                                         | `""`                     |
| `server.ingressGrpc.hostname`                              | Ingress hostname for the Jaeger gRPC server ingress                                                                            | `jaeger.server.local`    |
| `server.ingressGrpc.annotations`                           | Annotations for the Jaeger gRPC server ingress. To enable certificate autogeneration, place here your cert-manager annotations | `{}`                     |
| `server.ingressGrpc.tls`                                   | Enable TLS for the Jaeger server ingress                                                                                       | `false`                  |
| `server.ingressGrpc.extraHosts`                            | Extra hosts array for the Jaeger gRPC server ingress                                                                           | `[]`                     |
| `server.ingressGrpc.path`                                  | Path array for the Jaeger gRPC server ingress                                                                                  | `/`                      |
| `server.ingressGrpc.extraPaths`                            | Extra paths for the Jaeger gRPC server ingress                                                                                 | `[]`                     |
| `server.ingressGrpc.extraTls`                              | Extra TLS configuration for the Jaeger gRPC server ingress                                                                     | `[]`                     |
...
| `server.containerPorts.http`                               | Jaeger server HTTP container port                                                                                              | `8080`                   |
| `server.containerPorts.https`                              | Jaeger server HTTPS container port                                                                                             | `8443`                   |
| `server.containerPorts.metrics`                            | Jaeger server metrics container port                                                                                           | `8083`                   |
| `server.service.type`                                      | Jaeger service type                                                                                                            | `ClusterIP`              |
...
| `server.service.clusterIP`                                 | Jaeger service Cluster IP                                                                                                      | `""`                     |
| `server.service.loadBalancerIP`                            | Jaeger service Load Balancer IP                                                                                                | `""`                     |
| `server.service.loadBalancerSourceRanges`                  | Jaeger service Load Balancer sources                                                                                           | `[]`                     |
| `server.service.externalTrafficPolicy`                     | Jaeger service external traffic policy                                                                                         | `Cluster`                |
| `server.service.annotations`                               | Additional custom annotations for Jaeger service                                                                               | `{}`                     |
...
| `server.hostAliases`                                       | Jaeger server pods host aliases                                                                                                | `[]`                     |
| `server.podLabels`                                         | Extra labels for Jaeger server pods                                                                                            | `{}`                     |
| `server.podAnnotations`                                    | Annotations for Jaeger server pods                                                                                             | `{}`                     |
| `server.podAffinityPreset`                                 | Pod affinity preset. Ignored if `server.affinity` is set. Allowed values: `soft` or `hard`                                      | `""`                     |
| `server.podAntiAffinityPreset`                             | Pod anti-affinity preset. Ignored if `server.affinity` is set. Allowed values: `soft` or `hard`                                 | `soft`                   |
| `server.nodeAffinityPreset.type`                           | Node affinity preset type. Ignored if `server.affinity` is set. Allowed values: `soft` or `hard`                                | `""`                     |
| `server.nodeAffinityPreset.key`                            | Node label key to match. Ignored if `server.affinity` is set                                                                    | `""`                     |
| `server.nodeAffinityPreset.values`                         | Node label values to match. Ignored if `server.affinity` is set                                                                 | `[]`                     |
| `server.affinity`                                          | Affinity for Jaeger server pods assignment                                                                                     | `{}`                     |
| `server.nodeSelector`                                      | Node labels for Jaeger server pods assignment                                                                                  | `{}`                     |
| `server.tolerations`                                       | Tolerations for Jaeger server pods assignment                                                                                  | `[]`                     |
...
| `server.updateStrategy.type`                               | Jaeger server statefulset strategy type                                                                                        | `RollingUpdate`          |
| `server.priorityClassName`                                 | Jaeger server pods' priorityClassName                                                                                          | `""`                     |
| `server.runtimeClassName`                                  | Name of the runtime class to be used by pod(s)                                                                                  | `""`                     |
| `server.lifecycleHooks`                                    | for the Jaeger server container(s) to automate configuration before or after startup                                           | `{}`                     |
| `server.extraEnvVars`                                      | Array with extra environment variables to add to Jaeger server nodes                                                           | `[]`                     |
| `server.extraEnvVarsCM`                                    | Name of existing ConfigMap containing extra env vars for Jaeger server nodes                                                   | `""`                     |
| `server.extraEnvVarsSecret`                                | Name of existing Secret containing extra env vars for Jaeger server nodes                                                      | `""`                     |
| `server.extraVolumes`                                      | Optionally specify extra list of additional volumes for the Jaeger server pod(s)                                               | `[]`                     |
| `server.extraVolumeMounts`                                 | Optionally specify extra list of additional volumeMounts for the Jaeger server container(s)                                    | `[]`                     |
| `server.sidecars`                                          | Add additional sidecar containers to the Jaeger server pod(s)                                                                  | `[]`                     |
| `server.initContainers`                                    | Add additional init containers to the Jaeger server pod(s)                                                                     | `[]`                     |
...
### Jaeger repo server Parameters

| Name                                                           | Description                                                                                          | Value           |
| -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | --------------- |
| `repoServer.replicaCount`                                      | Number of Jaeger repo server replicas to deploy                                                     | `1`             |
| `repoServer.startupProbe.enabled`                              | Enable startupProbe on Jaeger repo server nodes                                                     | `false`         |
...
| `repoServer.livenessProbe.enabled`                             | Enable livenessProbe on Jaeger repo server nodes                                                    | `true`          |
...
| `repoServer.readinessProbe.enabled`                            | Enable readinessProbe on Jaeger repo server nodes                                                   | `true`          |
...
| `repoServer.resources.limits`                                  | The resources limits for the Jaeger repo server containers                                          | `{}`            |
| `repoServer.resources.requests`                                | The requested resources for the Jaeger repo server containers                                       | `{}`            |
| `repoServer.podSecurityContext.enabled`                        | Enabled Jaeger repo server pods' Security Context                                                   | `true`          |
| `repoServer.podSecurityContext.fsGroup`                        | Set Jaeger repo server pod's Security Context fsGroup                                               | `1001`          |
| `repoServer.containerSecurityContext.enabled`                  | Enabled Jaeger repo server containers' Security Context                                             | `true`          |
| `repoServer.containerSecurityContext.runAsUser`                | Set Jaeger repo server containers' Security Context runAsUser                                       | `1001`          |
| `repoServer.containerSecurityContext.allowPrivilegeEscalation` | Set Jaeger repo server containers' Security Context allowPrivilegeEscalation                        | `false`         |
| `repoServer.containerSecurityContext.capabilities.drop`        | Set Jaeger containers' repo server Security Context capabilities to be dropped                      | `["all"]`       |
| `repoServer.containerSecurityContext.readOnlyRootFilesystem`   | Set Jaeger containers' repo server Security Context readOnlyRootFilesystem                          | `false`         |
| `repoServer.containerSecurityContext.runAsNonRoot`             | Set Jaeger repo server containers' Security Context runAsNonRoot                                    | `true`          |
...
| `repoServer.logFormat`                                         | Format for the Jaeger repo server logs. Options: [text, json]                                       | `text`          |
| `repoServer.logLevel`                                          | Log level for the Jaeger repo server                                                                | `info`          |
| `repoServer.containerPorts.repoServer`                         | Container port for Jaeger repo server                                                               | `8081`          |
| `repoServer.containerPorts.metrics`                            | Metrics port for Jaeger repo server                                                                 | `8084`          |
| `repoServer.metrics.enabled`                                   | Enable metrics for the Jaeger repo server                                                           | `false`         |
| `repoServer.metrics.service.type`                              | Jaeger repo server service type                                                                     | `ClusterIP`     |
| `repoServer.metrics.service.port`                              | Jaeger repo server metrics service port                                                             | `8084`          |
| `repoServer.metrics.service.nodePort`                          | Node port for the repo server metrics service                                                        | `""`            |
| `repoServer.metrics.service.clusterIP`                         | Jaeger repo server metrics service Cluster IP                                                       | `""`            |
| `repoServer.metrics.service.loadBalancerIP`                    | Jaeger repo server service Load Balancer IP                                                         | `""`            |
| `repoServer.metrics.service.loadBalancerSourceRanges`          | Jaeger repo server service Load Balancer sources                                                    | `[]`            |
| `repoServer.metrics.service.externalTrafficPolicy`             | Jaeger repo server service external traffic policy                                                  | `Cluster`       |
| `repoServer.metrics.service.annotations`                       | Additional custom annotations for Jaeger repo server service                                        | `{}`            |
...
| `repoServer.autoscaling.enabled`                               | Enable Jaeger repo server deployment autoscaling                                                    | `false`         |
| `repoServer.autoscaling.minReplicas`                           | Jaeger repo server deployment autoscaling minimum number of replicas                                | `1`             |
| `repoServer.autoscaling.maxReplicas`                           | Jaeger repo server deployment autoscaling maximum number of replicas                                | `5`             |
| `repoServer.autoscaling.targetCPU`                             | Jaeger repo server deployment autoscaling target CPU percentage                                     | `50`            |
| `repoServer.autoscaling.targetMemory`                          | Jaeger repo server deployment autoscaling target CPU memory                                         | `50`            |
...
| `repoServer.hostAliases`                                       | Jaeger repo server pods host aliases                                                                | `[]`            |
| `repoServer.podLabels`                                         | Extra labels for Jaeger repo server pods                                                            | `{}`            |
| `repoServer.podAnnotations`                                    | Annotations for Jaeger repo server pods                                                             | `{}`            |
...
| `repoServer.affinity`                                          | Affinity for Jaeger repo server pods assignment                                                     | `{}`            |
| `repoServer.nodeSelector`                                      | Node labels for Jaeger repo server pods assignment                                                  | `{}`            |
| `repoServer.tolerations`                                       | Tolerations for Jaeger repo server pods assignment                                                  | `[]`            |
...
| `repoServer.updateStrategy.type`                               | Jaeger repo server statefulset strategy type                                                        | `RollingUpdate` |
| `repoServer.priorityClassName`                                 | Jaeger repo server pods' priorityClassName                                                          | `""`            |
| `repoServer.runtimeClassName`                                  | Name of the runtime class to be used by pod(s)                                                       | `""`            |
| `repoServer.lifecycleHooks`                                    | for the Jaeger repo server container(s) to automate configuration before or after startup           | `{}`            |
| `repoServer.extraEnvVars`                                      | Array with extra environment variables to add to Jaeger repo server nodes                           | `[]`            |
| `repoServer.extraEnvVarsCM`                                    | Name of existing ConfigMap containing extra env vars for Jaeger repo server nodes                   | `""`            |
| `repoServer.extraEnvVarsSecret`                                | Name of existing Secret containing extra env vars for Jaeger repo server nodes                      | `""`            |
| `repoServer.extraVolumes`                                      | Optionally specify extra list of additional volumes for the Jaeger repo server pod(s)               | `[]`            |
| `repoServer.extraVolumeMounts`                                 | Optionally specify extra list of additional volumeMounts for the Jaeger repo server container(s)    | `[]`            |
| `repoServer.sidecars`                                          | Add additional sidecar containers to the Jaeger repo server pod(s)                                  | `[]`            |
| `repoServer.initContainers`                                    | Add additional init containers to the Jaeger repo server pod(s)                                     | `[]`            |
...
### Shared config for Jaeger components
...
| `config.secret.jaegerServerTlsConfig.key`      | TLS key for the Jaeger config secret                                                                 | `""`   |
| `config.secret.jaegerServerTlsConfig.crt`      | TLS certificate for the Jaeger config secret                                                         | `""`   |
| `config.secret.jaegerServerAdminPassword`      | Jaeger server admin password. Autogenerated by default.                                              | `""`   |
| `config.secret.jaegerServerAdminPasswordMtime` | Jaeger server password modification time                                                             | `""`   |
| `config.secret.repositoryCredentials`          | Repository credentials to add to the Jaeger server confgi secret                                     | `{}`   |
...
The above parameters map to the env variables defined in [bitnami/jaeger](https://github.com/bitnami/containers/tree/main/bitnami/jaeger). For more information please refer to the [bitnami/jaeger](https://github.com/bitnami/containers/tree/main/bitnami/jaeger) image documentation.
...
The above command sets the jaeger controller replicas to 2, and enabled jaeger server metrics.
...
```console
helm install my-release -f values.yaml my-repo/jaeger
```
...
This chart provides support for Ingress resources. If an Ingress controller, such as nginx-ingress or traefik, that Ingress controller can be used to serve Jaeger.
...
The chart also facilitates the creation of TLS secrets for use with the Ingress controller, with different options for certificate management. [Learn more about TLS secrets](https://docs.bitnami.com/kubernetes/infrastructure/jaeger/administration/enable-tls-ingress/).

Apart from the Ingress TLS certificates, Jaeger repo server will auto-generate a secret named `jaeger-repo-server-tls`. This secret contains the TLS configuration for the Jaeger components. The secret will be created only if it does not exist, so if you want to add custom TLS configuration you can create a secret with that name before installing the chart.

### Default config maps and secrets

The chart has hardcoded names for some ConfigMaps and Secrets like `jaeger-ssh-known-hosts-cm`, `jaeger-repo-server-tls` or `jaeger-ssh-known-hosts-cm`. Jaeger will search for those specific names when the chart installed, so installing the chart twice in the same namespaces is not possible due to this restriction.
For more information about each configmap or secret check the references at the corresponding YAML files.

### Using SSO

In order to use SSO you need to enable Dex by setting `dex.enabled=true`. You can follow [this guide](https://jaeger.readthedocs.io/en/stable/operator-manual/user-management/#1-register-the-application-in-the-identity-provider) to configure your Jaeger deployment into your identity provider. After that, you need to configure Jaeger like described [here](https://jaeger.readthedocs.io/en/stable/operator-manual/user-management/#2-configure-jaeger-for-sso). You can set the Dex configuration at `server.config.dex\.config` that will populate the `jaeger-cm` config map.
...
Refer to the [chart documentation for more information about how to upgrade from previous releases](https://docs.bitnami.com/kubernetes/infrastructure/jaeger/administration/upgrade/).
